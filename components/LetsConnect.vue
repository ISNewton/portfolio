<template>
  <div>
    <div class="text-center">
      ...
      <SectionTitle id="letsconnect"> LET'S CONNECT </SectionTitle>
    </div>
    <div class="flex justify-center gap-8 mt-16">
      ...
      <div v-motion :delay="1000" :initial="{ opacity: 0, y: 100 }" :enter="{ opacity: 1, y: 0, scale: 1 }" class="mt-1">
        <a target="_blank" href="mailto:ash@lilash.dev" class="text-gray-800 hover:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" :fill="colorMode.preference == 'dark' ? 'white' : 'black'" width="25"
            height="25" viewBox="0 0 24 24">
            <title>Mail : ash@lilash.dev</title>
