  ...
  <div>
    <div class="text-center">
      <h3 class="font-space-mono font-bold text-center leading-none text-2xl font-hand py-8">
        I'm a team player, not a one-man band. Let's build something epic
        together!
      </h3>
      <SectionTitle>
        LET'S CONONECT
    ...
    <div
      class="dark:bg-[linear-gradient(45deg,transparent_25%,rgba(68,68,68,.2)_50%,transparent_75%,transparent_100%)]
      dark:bg-zinc-950  mx-auto mt-12 relative max-w-md overflow-hidden rounded-xl border border-slate-900 bg-[length:250%_250%,100%_100%] bg-[position:-100%_0,0_0] bg-no-repeat px-8 py-16 shadow-2xl transition-[background-position_0s_ease] hover:bg-[position:200%_0,0_0] hover:duration-[1500ms]">
      <div class="grid place-items-center">
        <div class="mx-auto rounded-full py-2 w-16">
          <img src="/images/ash.png" alt="profile" />
        </div>
        <!--name-->
        ...
        <div class="flex justify-center gap-8 mt-16">
          <div v-motion :delay="700" :initial="{ opacity: 0, y: 100 }" :enter="{ opacity: 1, y: 0, scale: 1 }" class="">
          ...
          <div v-motion :delay="800" :initial="{ opacity: 0, y: 100 }" :enter="{ opacity: 1, y: 0, scale: 1 }" class="">
            <a target="_blank" href="https://twitter.com/duy3_" class="text-gray-800 hover:text-gray-600">
              <svg width="35" height="35" viewBox="0 -4 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div v-motion :delay="900" :initial="{ opacity: 0, y: 100 }" :enter="{ opacity: 1, y: 0, scale: 1 }" class="">
            <a target="_blank" href="https://linkedin.com/in/ashraf-alhaj" class="text-gray-800 hover:text-gray-600">
              <svg :fill="colorMode.preference == 'dark' ? 'white' : 'black'" width="35" height="35"
